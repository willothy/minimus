...
local base = lush(function(injected_functions)
  ...
  return {
    ...
    NormalFloatNC {
      bg = nobg and 'none' or spec.bg.darken(10),
      fg = spec.text.darken(30).desaturate(50),
      bold = false,
    },
    ...
    FloatBorder { fg = spec.bg2.saturate(20).lighten(10), bg = spec.bg.darken(10) },
    FloatBorderTransparent { fg = spec.bg2.saturate(20).lighten(10), bg = 'none' },
    FloatTitle { fg = p.blue, bg = spec.bg.darken(10) },
    FloatTitleTransparent { fg = p.blue, bg = 'none' },
